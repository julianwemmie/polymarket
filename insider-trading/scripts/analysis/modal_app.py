...
Upload data to Modal volume:
  ...
  modal volume put polymarket-data \
      ../../../historical-data/processed/trades.csv /processed/trades.csv
  modal volume put polymarket-data \
      ../../../historical-data/markets.csv /markets.csv
...
Download results:
  modal volume get polymarket-data /output/signal1/ ./output-signal1/
  modal volume get polymarket-data /output/signal2/ ./output-signal2/
"""
...
VOL_PATH = "/vol"
S1_OUTPUT = f"{VOL_PATH}/output/signal1"
S2_OUTPUT = f"{VOL_PATH}/output/signal2"
