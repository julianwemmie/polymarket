...
token IDs to markets, computes price/direction/amounts, and writes to processed/trades.csv.
"""
import os
import time
import polars as pl
...
def process_trades(
    input_file: str = "goldsky/orderFilled.csv",
    output_file: str = "processed/trades.csv",
