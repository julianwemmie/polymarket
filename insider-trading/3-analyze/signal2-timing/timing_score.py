...
def compute_wallet_activity_baseline(
    ...
    while True:
        ...
        # Deduplicate neg-risk double-counts within same transaction
        wallet_chunk = wallet_chunk.unique(
            subset=["transactionHash", "wallet", "market_id"],
            keep="first",
